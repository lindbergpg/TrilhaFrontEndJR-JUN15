import { ContactContainer, TitlePag, TitleCard, ContactsCard, SocialMedia } from "./styles"
    ...
    <ContactContainer>
      ...
      <div>
        <TitleCard>REDES</TitleCard>
          <SocialMedia>
            <li>
              <a href="https://github.com/lindbergpg">
                <img src={git} />
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/lindbergpereira/">
                  <img src={linkedin} />
              </a>
            </li>
          </SocialMedia>
